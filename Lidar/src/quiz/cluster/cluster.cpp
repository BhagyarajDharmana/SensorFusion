...
void ClusterHelper(int index, const std::vector<std::vector<float>>points, KdTree *tree,float distanceTol,std::vector<int> &cluster,std::vector<bool> processed)
{
	...
	{
		if (!processed[id])
			ClusterHelper(id,points,tree,distanceTol,cluster,processed);
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	while(i < points.size())
	{
		...
		ClusterHelper(i,points,tree,distanceTol,cluster,processed);
